...
class ItemView(View):
    ...
    @discord.ui.button(label="Hate It",      style=discord.ButtonStyle.secondary, row=0)
    ...
    @discord.ui.button(label="Like It",      style=discord.ButtonStyle.secondary, row=0)
    async def like_it(self, interaction: discord.Interaction, button: Button):
        await self.handle_choice(interaction, "like")

    @discord.ui.button(label="Love It",      style=discord.ButtonStyle.secondary, row=0)
